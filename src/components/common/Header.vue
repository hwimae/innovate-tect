<template>
    ...
    <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <router-link to="/" class="flex items-center space-x-3 logo-link">
        <div class="flex flex-col">
          <img
            src="https://innovate-tech.monamedia.net/wp-content/uploads/2024/12/1-e1733720380317.png"
            alt="The Mona Logo"
            class="h-[40px] w-auto"
          />
        </div>
      ...
      <ul class="hidden lg:flex items-center space-x-8">
        <li>
          <router-link
            to="/"
            class="nav-link text-gray-700 hover:text-gray-900 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300"
          >
      ...
      <div class="flex items-center space-x-4">
        ...
        <router-link
          to="/lien-he"
          class="logo-link hidden md:block border border-blue-500 text-blue-500 px-4 py-2 rounded-full hover:bg-blue-500 hover:text-white transition text-sm font-medium"
        >
          Liên hệ ngay
        </router-link>
  ...
  <div
    ...
    :class="{
      'translate-y-0 opacity-100': showFloatingHeader,
      '-translate-y-10 opacity-0': !showFloatingHeader,
    }"
  >
    <div class="flex items-center justify-between w-full">
      ...
      <nav class="hidden lg:flex items-center space-x-3">
        <router-link
          to="/"
          class="nav-link text-gray-700 hover:text-gray-900 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300"
          @click="scrollToTop"
        >
          <span class="nav-text">TRANG CHỦ</span>
        </router-link>
      ...
      <div class="flex items-center space-x-4">
        <button
          class="hidden lg:block text-gray-600 hover:text-gray-800 transition p-2"
        >
          <svg
            class="w-6 h-6"
            fill="none"
        ...
        <router-link
          to="/lien-he"
          class="logo-link border border-blue-500 text-blue-500 px-8 py-3 rounded-full hover:bg-blue-500 hover:text-white transition text-sm font-medium"
        >
          Liên hệ ngay
        </router-link>
